      ...
      <main className="w-full">
        ...
        <section className="max-w-[1400px] mx-auto px-3 md:px-4 py-4 md:py-6">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
              <div className="relative overflow-hidden group cursor-pointer rounded-lg md:rounded-2xl shadow-md hover:shadow-lg transition-all duration-700 hover:-translate-y-1">
                 <div className="w-full h-48 md:h-64 overflow-hidden bg-gray-100">
                   <img src={diaperOfferImg} loading="lazy" className="w-full h-full object-cover transition-all duration-1000 group-hover:scale-110" />
                 </div>
                 <div className="absolute top-2 md:top-4 left-2 md:left-4 bg-red-500 text-white text-[10px] md:text-xs font-bold px-2.5 md:px-3 py-1 rounded-full">Limited</div>
                 <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/90 to-transparent p-3 md:p-6">
              ...
              <div className="relative overflow-hidden group cursor-pointer rounded-lg md:rounded-2xl shadow-md hover:shadow-lg transition-all duration-700 hover:-translate-y-1">
                 <div className="w-full h-48 md:h-64 overflow-hidden bg-gray-100">
                   <img src={footwearSaleImg} loading="lazy" className="w-full h-full object-cover transition-all duration-1000 group-hover:scale-110" />
                 </div>
                 <div className="absolute top-2 md:top-4 left-2 md:left-4 bg-orange-500 text-white text-[10px] md:text-xs font-bold px-2.5 md:px-3 py-1 rounded-full">New</div>
                 <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/90 to-transparent p-3 md:p-6">
